...
def train_diffusion_step(masking_proba=0.5, first_pass=False, model_path='../../../results/metric_MLP/model/MLP_diffusion_geo.pt'):
...
def main(epochs = 100):
    ...
    with open('../../../results/metric_MLP/data/train_MLP_diffusion_geo.json', 'w') as file:
