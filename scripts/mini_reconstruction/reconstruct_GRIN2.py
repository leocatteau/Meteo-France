...
def main(): 
    ...
    with open(f'../../../results/mini_reconstruction/data/reconstruction_losses_GRIN_overlap.pkl', 'wb') as file:
        pickle.dump(losses, file)
    print("Reconstruction saved.")

    with open(f'../../../results/mini_reconstruction/data/reconstructed_data_GRIN_overlap.pkl', 'wb') as file:
        pickle.dump(reconstructed_data.tolist(), file)

    with open(f'../../../results/mini_reconstruction/data/original_data_GRIN_overlap.pkl', 'wb') as file:
        pickle.dump(original_data.tolist(), file)

    with open(f'../../../results/mini_reconstruction/data/corrupted_data_GRIN_overlap.pkl', 'wb') as file:
        pickle.dump(corrupted_data.tolist(), file)

    with open(f'../../../results/mini_reconstruction/data/mask_GRIN_overlap.pkl', 'wb') as file:
