...
def main(): 
    ...
    filler_kwargs.model_path = '../../../results/mini_reconstruction/model/GRIN_24h_attn_impute_mlp_grad01_processed.pt'
    ...
    with open(f'../../../results/mini_reconstruction/data/reconstruction_losses_GRIN_processed.pkl', 'wb') as file:
        pickle.dump(losses, file)
    print("Reconstruction saved.")

    with open(f'../../../results/mini_reconstruction/data/reconstructed_data_GRIN_processed.pkl', 'wb') as file:
        pickle.dump(reconstructed_data.tolist(), file)

    with open(f'../../../results/mini_reconstruction/data/original_data_GRIN_processed.pkl', 'wb') as file:
        pickle.dump(original_data.tolist(), file)

    with open(f'../../../results/mini_reconstruction/data/corrupted_data_GRIN_processed.pkl', 'wb') as file:
        pickle.dump(corrupted_data.tolist(), file)

    with open(f'../../../results/mini_reconstruction/data/mask_GRIN_processed.pkl', 'wb') as file:
        pickle.dump(mask.tolist(), file)

    with open(f'../../../results/mini_reconstruction/data/predictors_processed.json', 'w') as file:
