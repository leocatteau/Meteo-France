...
class Filler():
    ...
    #     return original_data.cpu().numpy(), corrupted_data.cpu().numpy(), self.predictors, mask_tensor.cpu().numpy(), evaluation_mask.cpu().numpy(), self.reconstructed_data, rmse_value.item(), mae_value.item(), rg_rmse_value.item(), rg_mae_value.item()
